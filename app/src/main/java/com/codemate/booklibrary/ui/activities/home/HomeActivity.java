...
import com.codemate.booklibrary.ui.activities.dialogmaterialsearchview.DialogMaterialSVActivity;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private Button btnDialogMaterialSearchView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDialogMaterialSearchView = (Button) findViewById(R.id.btnDialogMaterialSearchView);
        ...
        btnDialogMaterialSearchView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HomeActivity.this, DialogMaterialSVActivity.class));
            }
        });
    }
}
